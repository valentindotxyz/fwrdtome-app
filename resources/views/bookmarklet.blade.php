...
@section('content')
    <p style="text-align: center; font-size: 26px; text-transform: uppercase;">
        ...
        <a href='javascript: !function(){var e=document.createElement("img");e.setAttribute("src", "{{ env('APP_URL') }}/send2?api={{ $apiKey }}&url="+window.location.href+"&title="+encodeURI(document.title));e.style.display="none";document.body.appendChild(e);alert("Fwrdto.me: Link sent!")}();' class="button special animated flash" title="Fwrdto.me">Fwrdto.me</a>
    </p>
@endsection