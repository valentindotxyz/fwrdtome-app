...
@section('content')
    <p style="text-align: center; font-size: 26px; text-transform: uppercase;">
        <i class="fa fa-arrow-down fa-fw" aria-hidden="true"></i> <strong>Drag'n'drop this button to your favorite's bar! <i class="fa fa-arrow-down fa-fw" aria-hidden="true"></i></strong><br /><br />
